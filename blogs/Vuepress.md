...
访问命令行输出的ip地址，一般为`http://localhost:8080`(若端口被占用则依次递增，以终端输出为准)，即可访问您的博客了！![](http://img.hjxie.icu/image-20200816143942667-20200819182220954.png)
...
![](http://img.hjxie.icu/dac075bdb993bafd75f331693ba6357a5038c620.png)
